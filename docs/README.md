...
| [`HLD.md`](HLD.md) | High-level architecture, system context, runtime view, major flows, ERD, AI/RAG view, observability view, and deployment view |
| [`LLD.md`](LLD.md) | Low-level backend design, modules, API design, data model, and non-functional design notes |
| [`OBSERVABILITY_LLD.md`](OBSERVABILITY_LLD.md) | Implementation-level logging, metrics, tracing, correlation, and feature-instrumentation design |
...
- Keep general backend implementation design in `LLD.md`.
- Keep detailed observability implementation decisions in `OBSERVABILITY_LLD.md`.
